// To DO
// HIGH Priority
// date entered in HTML is not fed into SongKick API - urgent
// be sure to remove +1 for populatedatedropdownto
//
// MEDIUM Priority
// put current video/event details at base of video
//
// LOW Priority
// ensure artists already listed for current search are being removed when conducting a follow up search - perhaps put a 'more shows' button, seperate to the run api button
// add a random event button, searches even more than the 6 options displayed
// explore other info provided by songkick api
// further specific details for loaded video, such as...
    // distance to, time until, buy tickets link, songkick logo (actually required)
    // funny little calculator that shows percentage of avg weekly wage a ticket costs, equivalent to cups of coffee or something
    // random articles on how concerts improve health
//
// FUTURE priority
// option to flag particular video as not one of the artists

var WordsObj = {
    "AUSTRALIA": ["string", "string", "string"],
    "CANADA": "",
    "EGYPT": "",
    "FRANCE": {
        "population": 1000,
...
for (i = 0; i < WordsObj.AUSTRALIA.length; i++) {
    WordsArray.AUSTRALIA[i];
    }

MyObj.FRANCE.population
console.log(WordsObj.FRANCE.favFoods[0]);
// object > key > 

MyObj.FRANCE.favFoods
console.log(WordsObj.FRANCE.favFoods[0]);
